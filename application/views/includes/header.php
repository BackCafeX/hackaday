...
<div class="w3-top" style="background-color:#0099cc">
 <div class="w3-bar w3-left-align w3-large" style="background-color:#0099cc; color:#ffffff;" >
  ...
  <button onclick="window.location.href='<?php echo base_url();?>index.php/Auth/logout'" class="w3-bar-item w3-button w3-padding-large w3-hover-white w3-right" title="News">
