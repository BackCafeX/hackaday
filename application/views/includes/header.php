...
<body style="background-color:#f6ffff">
	...
	<div class="w3-top" style="background-color:#0099cc">
		<div class="w3-bar w3-left-align w3-large" style="background-color:#0099cc; color:#ffffff; padding-right:30px;" >
		
			<!-- Home -->
			<button href="<?php echo base_url()?>/index.php/home" style=" background-color:#0086b3; text-shadow:1px 1px 0 #444" class="w3-bar-item w3-btn w3-padding-large "><i class="fa fa-home w3-margin-right"></i>Home</button>
