				...
				<div class="row">
					<div class="col-md-4 login-sec">
						...
						<div class="form-group">
							<label class="text-uppercase">รหัสนิสิต</label>
						...
						<div class="form-check">
							<input type="submit" style="padding-right: 10px" name="blogin" class="btn btn-login float-right " value="เข้าสู่ระบบ">
						</div>
						<?php echo form_close();?>
						...
						<div class="modal fade" id="myModal" tabindex="-1" role="" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered" role="" >
								<div class="modal-content">
									...
									<!-- Action post data to controller --> 
									...
									<div class="modal-body">
										...
										<div class="row">
											...
											<div class="col-sm-8 form-group">
												...
												<input class="form-control-2" type="number" name="member_age" min="16" max="70" placeholder="มากกว่า 15 ปี">
											</div>
											
											<!-- Enter gender -->
											<div class="col-sm-4">
												<label class="check-box text-uppercase"> 
									...
									<div class="modal-footer">
										...
										<!-- Cancle register -->
										<button type="submit" class="btn btn-secondary" style="background-color: #ff4d4d; border: none"data-dismiss="modal">ยกเลิก</button>
